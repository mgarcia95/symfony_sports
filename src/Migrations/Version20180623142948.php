...
final class Version20180623142948 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, date DATETIME NOT NULL, created DATETIME NOT NULL, place VARCHAR(255) NOT NULL, sport VARCHAR(255) NOT NULL, maxslot INT NOT NULL, comments VARCHAR(200) NOT NULL, INDEX IDX_3BAE0AA77E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
